<%@ Page Title="" Language="C#" MasterPageFile="~/ProgenY-Services/ProgenY.master" AutoEventWireup="true" CodeFile="index.aspx.cs" Inherits="preview_dotnet_templates_akshara_multi_master_index" %>
    ...
    <div id="carousel-example-generic" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <ol class="carousel-indicators">
            <li data-target='#carousel-example-generic' data-slide-to='0' class='active'>
                <asp:Image ID="Image1" runat="server" ImageUrl="~/ProgenY-Services/img/12.jpg"
                    Width="50px" Height="50px" CssClass="img-circle" /></li>
            <li data-target='#carousel-example-generic' data-slide-to='1'>
                <asp:Image ID="Image2" runat="server" ImageUrl="~/ProgenY-Services/img/13.jpg"
                    Width="50px" Height="50px" CssClass="img-circle" /></li>
          
            <li data-target='#carousel-example-generic' data-slide-to='2'>
                <asp:Image ID="Image3" runat="server" ImageUrl="~/ProgenY-Services/img/14.jpg"
                    Width="50px" Height="50px" CssClass="img-circle" /></li>
        </ol>
        <!-- Wrapper for slides -->
    ...
    <section class="service-info padding100">
        <div class="container">
            <div class="row">
                ...
                <!-- ./ app info box -->
                <div class="col-md-6">
                    <img src="~/akshara-multi-master/img/2.png"  runat="server" class="img-responsive" alt="" />
                </div>
                <!-- ./ app info box -->
            </div>
        </div>
